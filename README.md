<p align="center">
  <img src="assets/cover.png" alt="GenoScribe Banner" style="width:100%; border-radius: 10px;">
</p>
...
Este repositorio es un **ejemplo de informe de Spatial Transcriptomics generado con GenoScribe**, diseñado para mostrar de manera accesible las capacidades del sistema de generación de informes.  
...
**Spatial Transcriptomics** es una técnica de análisis transcriptómico que permite estudiar la **expresión génica preservando la información espacial dentro de un tejido**, a diferencia del Bulk RNA-Seq y del Single-Cell RNA-Seq, que pierden el contexto anatómico.  

🔹 **Aplicaciones principales de la Spatial Transcriptomics:**  
- 🗺️ Identificación de **regiones o dominios espaciales** con perfiles de expresión diferenciados.  
- 🔍 Análisis de **expresión génica diferencial entre zonas del tejido**.  
- 🧩 Integración con datos de **Single-Cell RNA-Seq** para mapear tipos celulares en el espacio.  
- 🧠 Estudio de la **organización tisular y microambientes celulares**.  

⚡️ **Ventajas de GenoScribe:**  
- Genera **informes interactivos** con gráficos, tablas y visualizaciones espaciales.  
...
Además, cada informe incorpora un **Mini Chatbot RAG** para interactuar con la información contenida y obtener datos adicionales sobre GenoScribe y análisis bioinformáticos.  
Si se quisiera ejecutar localmente, se usaría un script en `resources/1-essential/3-scripts/5-python/run_report_server.sh` para levantar un servidor local y abrir el informe con todas las funcionalidades.
...
Este GIF anterior muestra la **estructura y funcionalidad del informe**, incluyendo gráficos, tablas y resúmenes de la expresión génica.
